...
one plays automatically as soon as it's here.
  ...
  helicopter.mp3          Plays the instant the WINNING pick is made --
                        the moment the helicopter first appears and
                        starts its ~8.8-second descent, well BEFORE
                        the "Rescued!" screen itself shows up -- and
                        that's also the moment walk.mp3 (the
...
Format: card-flip.mp3, game-over.mp3, helicopter.mp3, and win.mp3 are
...
for correct/wrong/card-flip/hunger-low/game-over/helicopter/win.
...
silent in some browsers (Chrome in particular), while the other seven

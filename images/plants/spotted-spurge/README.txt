Spotted Spurge — photo files (PLACEHOLDER PAIR — not wired into the
walk yet, see the DATA comment above plantPairs in index.html)
...
card automatically as soon as it's here.
